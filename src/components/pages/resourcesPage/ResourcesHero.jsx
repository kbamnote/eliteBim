          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="pt-8 animate-fade-in-up delay-900">
              ...
              <div className="flex flex-wrap gap-6 items-center opacity-70">
                ...
                <div className="text-white font-bold text-2xl hover:text-yellow-300 transition-colors">Navisworks</div>
                <div className="text-white font-bold text-2xl hover:text-pink-300 transition-colors">AutoCAD</div>
              </div>
            </div>
          </div>
